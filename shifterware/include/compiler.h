#ifndef SHIFTER_COMPILER_H
#define SHIFTER_COMPILER_H

/* Cross-compiler attribute helpers. We support GCC only. */
...
/* Cortex-M0 barriers via inline asm. (No CMSIS; we want zero deps.) */
...
ALWAYS_INLINE void __wfe(void)  { __asm volatile ("wfe"); }
