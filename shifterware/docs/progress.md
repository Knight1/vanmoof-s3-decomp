...
_Total functions: 129 (the `USART1_IRQHandler` at `0x0800450C` was
created in the previous round)._
...
| `0x0800325c` |   22 | `FUN_0800325c` |  | pending |  |
...
| `0x080033cc` |   22 | `FUN_080033cc` |  | pending |  |
...
| `0x08004dbc` |   20 | `FUN_08004dbc` |  | pending |  |
