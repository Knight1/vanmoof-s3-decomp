...
- `ble.c` / `ble_read.c` — the **BLE app-command surface**, both dispatchers
  ...
  reproduced verbatim. (The `maybe_set_pending_request` REQ_* descriptor
  addresses remain approximate, pending a separate pass.) Maps:
