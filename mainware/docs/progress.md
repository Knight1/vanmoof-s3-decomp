...
| 0   | in-progress |
| 217 | decomp-c — `systick.c` (3), `console.c` (49), `scheduler.c` (7), `exceptions.c` (10), `panic.c` (2), `app.c` (16), `util.c` (4), `system_stm32f413.c` (1), `ssp.c` (9), `flash.c` (6), `crc.c` (3), `audio.c` (1), `log.c` (8), `sensor.c` (2), `uart.c` (1), `net.c` (2), `gpio.c` (1), `eeprom.c` (1), `i2c.c` (2), `watchdog.c` (5), `states.c` (2), `modem.c` (16), `ble.c` (1), `ble_read.c` (1), `update.c` (1), `main.c` (4), `battery.c` (18), `display.c` (33), `lighting.c` (8), `display_requests.c` (data: 38 descriptors) — see per-module log below |
