...
| 0   | in-progress |
| 515 | decomp-c — `vectors.c` (25), `tim.c` (9), `stc3115.c` (16), `console_edit.c` (12), `systick.c` (3), `console.c` (65), `scheduler.c` (8), `exceptions.c` (10), `panic.c` (2), `app.c` (24), `util.c` (6), `system_stm32f413.c` (1), `ssp.c` (22), `motor.c` (9), `flash.c` (7), `crc.c` (6), `audio.c` (1), `log.c` (10), `sensor.c` (9), `uart.c` (8), `bus.c` (3), `net.c` (2), `gpio.c` (5), `eeprom.c` (3), `i2c.c` (21), `watchdog.c` (6), `states.c` (7), `modem.c` (55), `ble.c` (5), `ble_read.c` (3), `rtc.c` (9), `update.c` (1), `main.c` (4), `battery.c` (29), `display.c` (33), `lighting.c` (9), `display_requests.c` (data: 38 descriptors), `shifter.c` (39), `lis3dh.c` (26), `comm.c` (2) — see per-module log below |
