...
| Count | Status |
| --- | --- |
| 434 | pending (auto-named `FUN_xxxxxxxx`) |
...
- `display.c` — **the LED-matrix display engine**, now SOURCED (33 functions,
  ...
  GPIO-init struct for the bus-recovery path.
