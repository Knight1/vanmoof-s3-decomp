...
| [`bleboot/`](bleboot/)   | `bleboot 1.0.0`    | TI CC2642R1F (Cortex-M4F)    | BLE-MCU bootloader (TI BIM — image select + verify + jump, occupies last 8 KB flash page incl. CCFG) | 8 KB | active — `38 decomp-c / 2 vendor-stock / 5 named / 18 pending` |
