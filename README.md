...
| [`mainware/`](mainware/) | `mainware 1.07.06` | ST STM32F413VGT6 (Cortex-M4) | main-controller application (BLE, modem, kick-lock, sound, power state, subsystem updaters) | ~213 KB | active — `2 decomp-c / 1 vendor-stock / 7 named / 800 pending` |
