...
| [`bleboot/`](bleboot/)   | `bleboot 1.0.0`    | TI CC2642R1F (Cortex-M4F)    | BLE-MCU bootloader (TI BIM — image select + verify + jump, occupies last 8 KB flash page incl. CCFG) | 8 KB | active — `65 decomp-c / 0 vendor-stock / 1 named / 0 pending` (every function decoded; builds an 8 KB comparable image with all static-data regions byte-identical to OEM; **Unicorn-validated against OEM** — see [bleboot/README.md](bleboot/README.md)) |
